...
var tupleToObject = function tupleTooObject(tuple){
  var obj = {};
  obj[tuple[0]] = tuple[1];
  return obj;
};
...
var strToKeys = function strToKeys(arr){
  var obj = {};
  for (var i=0;i<arr.length;i++){
    obj[arr[i]] = 0;
  }
...
var mapStringCounts = function mapStringCounts(arr){
  var obj = {};
  for (var i=0;i<arr.length;i++){
    if(arr[i].length>=5){obj[arr[i]]=true}
...
var charCountMap = function charCountMap(arr){
  var obj = {};
  for (var i=0;i<arr.length;i++){
